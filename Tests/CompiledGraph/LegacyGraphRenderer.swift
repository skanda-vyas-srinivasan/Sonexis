// Frozen pre-optimization renderer for offline regression/benchmark comparison.
// Keep this test reference independent of GraphRoutingPlan.
import Accelerate
import Foundation
@testable import Sonexis

final class LegacyGraphRenderer {
